...
const projectData = [
  ...
  {
    image: './img/la8marketing.png',
    title: 'la8Marketing',
    client_info: ['GROUP CONSTRUC VALLES', 'Full-stack Dev', '2023'],
    text: 'la8marketing is a professional and attractive website developed with Laravel and TailwindCSS that represents the image of the agency "la8marketing" and helps you position yourself on the web, attract clients and generate sales.',
    long_text: 'la8marketing is a professional and attractive website that represents the image of the "la8marketing" agency and helps you position yourself on the web, attract clients and generate sales. The website was developed with Laravel, an open source PHP framework that offers a wide range of functionalities and tools for creating websites. TailwindCSS was used for the design, an open source CSS framework that provides a wide range of ready-to-use components. TailwindCSS allows you to create modern and responsive designs easily and quickly. The website adapts to any device, from desktop to mobile devices. The website is optimized for search engines, which helps improve its visibility in search results. The website includes contact forms so visitors can contact the agency.',
    skills: ['Laravel', 'HTML5', 'TailwindCSS', 'javascript'],
    source: '#',
    livelink: 'https://la8marketing.com/',
  },
  {
